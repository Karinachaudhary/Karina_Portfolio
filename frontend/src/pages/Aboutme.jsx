...
export default function Aboutme() {
  ...
  const hobbyData = {
    exploring: {
      ...
      items: [
        { title: "Mountain Trail", location: "Himalayan Ridge", img: "/travel1.jpg" },
        { title: "Lake View", location: "Pokhara", img: "/travel2.jpg" },
        { title: "Sunset Peak", location: "Nagarkot", img: "/travel3.jpg" },
      ]
    },
    books: {
    ...
    music: {
      title: "Music & Beats 🎧",
      desc: "Deep lo-fi beats, synthwave, and coding soundtracks.",
      items: [
        { title: "Midnight Synthwave", location: "Coding Vibe", img: "/music1.jpg" },
        { title: "Acoustic Chill", location: "Focus Session", img: "/music2.jpg" },
        { title: "Lo-Fi Beats", location: "Late Night Build", img: "/music3.jpg" },
      ]
    }
  }
        ...
        >
          ...
          <div className="absolute inset-0 z-0 bg-[#162720] flex flex-col justify-between p-5 sm:p-8 text-[#f5f0e8]">
            ...
            <div className="space-y-4 max-w-lg ml-auto text-right my-2">
              ...
              {/* Photo Cards Grid with onPointerDown stopPropagation */}
              <div className="grid grid-cols-3 gap-2.5 pt-2 pointer-events-auto">
                {hobbyData[activeHobby].items.map((item, idx) => (
                  <div
                    ...
                    className="group relative rounded-xl overflow-hidden border border-[#7bcbb4]/30 bg-[#1d352b] h-24 sm:h-28 cursor-pointer hover:border-[#7bcbb4] transition-all shadow-md"
                  >
                    <img
                      src={item.img}
                      alt={item.title}
            ...
            <div className="text-right text-[11px] font-mono text-[#a7d4c5]/60">
              [ Click photos to view • Drag handle to reveal Tech World ]
            </div>
          </div>
            ...
            >
              ...
              <div className="space-y-4 max-w-md">
                ...
                <div className="flex flex-wrap gap-2 pt-2 font-mono text-[10px] sm:text-xs">
                  ...
                  <span className="px-2.5 py-1 rounded-lg bg-[#1a2e1f] border border-[#7bcbb4]/30 text-[#7bcbb4]">C++ / CP</span>
            ...
            >
              ...
              <div className="rounded-2xl overflow-hidden border border-[#7bcbb4]/20 bg-[#13241d] h-64 flex items-center justify-center">
                ...
                <span className="text-xs text-[#a7d4c5]/60 font-mono absolute">
                  [ Add your photo to public/{selectedPhoto.img.replace('/', '')} ]
                </span>
              </div>
            </div>
          </div>
